import { k as fromSso, C as CredentialsProviderError, l as getSSOTokenFromFile, s as setCredentialFeature, j as getProfileName, p as parseKnownFiles, m as loadSsoSessionData } from "./index.js";
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger }) => {
  ...
  const { SSOClient, GetRoleCredentialsCommand } = await import("./loadSso-AOe2xu6s.js");
