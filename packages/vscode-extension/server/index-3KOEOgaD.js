...
import require$$0, { PassThrough, pipeline as pipeline$1 } from "node:stream";
import { Buffer as Buffer$1 } from "node:buffer";
import { types, deprecate, promisify } from "node:util";
import { ax as commonjsGlobal } from "./index.js";
...
function requirePonyfill_es2018() {
  ...
  (function(module, exports$1) {
    (function(global, factory) {
      factory(exports$1);
    })(ponyfill_es2018, (function(exports$12) {
      function noop() {
        return void 0;
      }
...
const pipeline = promisify(require$$0.pipeline);
...
class Body {
  constructor(body, {
    ...
    } else if (body instanceof require$$0) ;
    ...
    if (Buffer$1.isBuffer(body)) {
      stream = require$$0.Readable.from(body);
    } else if (isBlob(body)) {
      stream = require$$0.Readable.from(body.stream());
    }
    this[INTERNALS$2] = {
      body,
      stream,
  ...
  async formData() {
    ...
    const { toFormData } = await import("./multipart-parser-CBB-xmAh.js");
...
const clone = (instance, highWaterMark) => {
  ...
  if (body instanceof require$$0 && typeof body.getBoundary !== "function") {
...
async function fetch(url, options_) {
  return new Promise((resolve, reject) => {
    ...
    const send = (parsedURL.protocol === "https:" ? require$$1 : http).request;
    const { signal } = request;
    let response = null;
    const abort = () => {
      const error = new AbortError("The operation was aborted.");
      reject(error);
      if (request.body && request.body instanceof require$$0.Readable) {
      ...
      if (isRedirect(response_.statusCode)) {
        ...
        switch (request.redirect) {
          ...
          case "follow": {
            ...
            if (response_.statusCode !== 303 && request.body && options_.body instanceof require$$0.Readable) {
