...
- [x] 4a.4 Make the identity feed deduplication: the canonical form is what the visited set is keyed on, so a `.md` URL and its canonical form collapse to one page regardless of which is seen first.
